...
//				page.setRotationY(position * -30);				
    ...
    private List<Fragment> getFragments(){
        ...
        FragmentGenreMain f1 = FragmentGenreMain.newInstance(String.valueOf(fragmentCounter));
        fragmentCounter++;
        FragmentGenreMain f2 = FragmentGenreMain.newInstance(String.valueOf(fragmentCounter));
        fragmentCounter++;
        fList.add(f1);
        fList.add(f2);
