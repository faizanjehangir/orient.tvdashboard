...
public class TabMixes extends FragmentActivity implements OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.setOnPageChangeListener(TabMixes.this);
...
//				page.setRotationY(position * -30);				
    ...
    private List<Fragment> getFragments(){
        ...
        FragmentMixesMain f1 = FragmentMixesMain.newInstance(String.valueOf(fragmentCounter));
        fragmentCounter++;
        FragmentMixesMain f2 = FragmentMixesMain.newInstance(String.valueOf(fragmentCounter));
        fragmentCounter++;
        fList.add(f1);
        fList.add(f2);
