...
public class MusicVideos extends FragmentActivity implements OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.setOnPageChangeListener(MusicVideos.this);
...
//				page.setRotationY(position * -30);				
    ...
    private List<Fragment> getFragments(){
        ...
        MusicVideosFragmentMain f1 = MusicVideosFragmentMain.newInstance();
        MusicVideosFragmentMain f2 = MusicVideosFragmentMain.newInstance();
        MusicVideosFragmentMain f3 = MusicVideosFragmentMain.newInstance();
