...
//				page.setRotationY(position * -30);				
    ...
    private List<Fragment> getFragments(){
        ...
        FragmentMusicVideosMain f1 = FragmentMusicVideosMain.newInstance(String.valueOf(fragmentCounter));
        fragmentCounter++;
        FragmentMusicVideosMain f2 = FragmentMusicVideosMain.newInstance(String.valueOf(fragmentCounter));
        fragmentCounter++;
        FragmentMusicVideosMain f3 = FragmentMusicVideosMain.newInstance(String.valueOf(fragmentCounter));
        fragmentCounter++;
        fList.add(f1);
        fList.add(f2);
        fList.add(f3);
