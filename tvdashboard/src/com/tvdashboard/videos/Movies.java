...
public class Movies extends FragmentActivity implements OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.setOnPageChangeListener(Movies.this);
...
//				page.setRotationY(position * -30);				
    ...
    private List<Fragment> getFragments(){
        ...
        MoviesFragmentMain f1 = MoviesFragmentMain.newInstance();
        MoviesFragmentMain f2 = MoviesFragmentMain.newInstance();
