...
//				page.setRotationY(position * -30);				
    ...
    private List<Fragment> getFragments(){
        ...
        FragmentMoviesMain f1 = FragmentMoviesMain.newInstance(String.valueOf(fragmentCounter));
        fragmentCounter++;
        FragmentMoviesMain f2 = FragmentMoviesMain.newInstance(String.valueOf(fragmentCounter));
        fragmentCounter++;
        fList.add(f1);
        fList.add(f2);
