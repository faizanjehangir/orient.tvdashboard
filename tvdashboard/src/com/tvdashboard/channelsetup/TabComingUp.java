...
public class TabComingUp extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pageAdapter = new ChannelSetupPageAdapter(getSupportFragmentManager(),
				fragments);
	...
	private List<Fragment> getFragments() {
		...
		FragmentComingUpMain f1 = FragmentComingUpMain.newInstance(String
