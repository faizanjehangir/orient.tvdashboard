...
public class TabTvGuide extends FragmentActivity implements OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.setOnPageChangeListener(TabTvGuide.this);
...
//				page.setRotationY(position * -30);				
    ...
    private List<Fragment> getFragments(){
        ...
        FragmentTvGuideMain f1 = FragmentTvGuideMain.newInstance(String.valueOf(fragmentCounter));
        fList.add(f1);
