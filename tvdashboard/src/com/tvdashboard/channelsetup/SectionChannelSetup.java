...
//	        }
	...
	// ****************************************************************** //
     		...
     		TabSpec tab1 = tabHost.newTabSpec("TV Guide");
     		TabSpec tab2 = tabHost.newTabSpec("Now Showing");
     		TabSpec tab3 = tabHost.newTabSpec("Coming Up");
     		tab1.setIndicator("TV Guide");
     		tab1.setContent(new Intent(this, TabTvGuide.class));
     		tab2.setIndicator("Now Showing");
     		tab2.setContent(new Intent(this, TabNowShowing.class));
     		tab3.setIndicator("Coming Up");
     		tab3.setContent(new Intent(this, TabComingUp.class));
     		tabHost.addTab(tab1);
     		tabHost.addTab(tab2);
     		tabHost.addTab(tab3);
