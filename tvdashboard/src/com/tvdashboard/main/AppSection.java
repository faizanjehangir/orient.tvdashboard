...
public class AppSection extends SherlockFragmentActivity {
	...
	private ImageButton btnOpenLeftMenu,btnSelect, btnReturn, btnBrowse;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        appSettings = (ImageButton) findViewById(R.id.settings_app);
        downloadApp = (ImageButton) findViewById(R.id.download_app);
